  ...
  return (
    <section className={Style.aboutContainer} id='about'>
      ...
      <p className={Style.p}>
        ...
        technologies. <br />
        <br /> During my time as a Frontend ReactJS Developer Intern with
        HNG/Zuri, I gained valuable experience building web and desktop
        applications. This experience, coupled with my ability to work
        collaboratively in an agile environment and my attention to detail, has
        prepared me for new challenges in the tech industry. <br />
        <br /> I am excited to take on new opportunities and work with dynamic
        and fast-growing companies. I am committed to delivering pixel-perfect
